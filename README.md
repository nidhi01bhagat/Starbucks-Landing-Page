...
Key areas I focused on:
 Understanding layout systems using Flexbox and CSS Grid
 Writing semantic HTML for better structure and readability
 Implementing responsiveness using media queries
  Debugging layout and alignment issues through trial and iteration

## Challenges Faced
* Making the layout responsive across different screen sizes
* Maintaining consistent alignment and spacing
* Structuring CSS in a clean and manageable way
